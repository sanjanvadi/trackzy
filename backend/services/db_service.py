...
async def get_ledgers(db: AsyncSession, uid: str) -> list[Ledger]:
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not retrieve Ledgers")

# async def get_default_ledger(db: AsyncSession, uid: str) -> Ledger:
#     ledger = await db.execute(
#         select(Ledger)
#         .where(Ledger.is_default == True)
#     )
#     print(ledger)
#     if not ledger:
...
async def get_ledger(db: AsyncSession, uid: str, ledger_id: str) -> Ledger:
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not retrieve Ledger")
...
async def create_ledger(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not create Ledger")
...
async def update_ledger(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not update Ledger")
...
async def set_default_ledger(db: AsyncSession, uid: str, ledger_id: str) -> None:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not set Ledger as default")
...
async def delete_ledger(db: AsyncSession, uid: str, ledger_id: str) -> None:
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not delete Ledger")
...
async def resolve_ledger_id(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not resolve Ledger")
...
async def get_expense(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not fetch expense")
...
async def list_expenses(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not list expenses")
...
async def update_expense_db(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not update expense")
...
async def get_expense_summary(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Could Not fetch expense summary")
